...
def main():
    ...
    print(
        max(myList)
    )  # Utilizing builtin function max() to find max amongst the elements of list
    print(
        min(myList)
    )  # Utilizing builtin function min() to find min amongst the elements of list
    ...
    )  # Returns all possible combinations of 2nd no. of elements
